...
public class DetectionTest2 {
    ...
    @Test
    public void validatePurpleViolation() {
        Detection detection1 = new Detection(volvo1, "Amsterdam",
                LocalDateTime.of(2022, 10, 1, 12, 11, 10));
    ...
    @Test
    public void validatePurpleNoViolation() {
        Detection detection2 = new Detection(scoda, "Rotterdam",
                LocalDateTime.of(2022, 10, 1, 12, 11, 10));
